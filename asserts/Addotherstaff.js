        ...
        <SafeAreaView>
            <ScrollView>
                ...
                <View style={{ flex: 1, backgroundColor: colors.primary, justifyContent: 'center', }}>
                    ...
                    <Button textColor={colors.text} buttonColor={colors.bg} labelStyle={{ fontSize: 20, color: colors.text, fontWeight: 'bold' }} style={{ width: '40%', height: 60, borderColor: colors.primary, justifyContent: "center", alignSelf: 'center', borderRadius: 10, marginTop: 30, }} onPress={()=>navigation.navigate('Otherstafflist')}>
                        ADD
                    </Button >
