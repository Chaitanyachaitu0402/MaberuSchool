...
export default function Profile({ navigation }) {
  ...
  const home=()=>{
    navigation.navigate("Directoreditprofile")
}
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.primary }}>
      ...
      <View style={{ backgroundColor: colors.background, height: 150, width: '100%', borderBottomRightRadius: 44, borderBottomLeftRadius: 44 }}>
        ...
        <Button textColor={colors.text} buttonColor={colors.bg} labelStyle={{ fontSize: 20, color: colors.text, fontWeight: 'bold' }} style={{ width: '40%', height: 60, borderColor: colors.primary, justifyContent: "center", alignSelf: 'center', borderRadius: 6, margin:9 }}onPress={home} >
          Edit Profile
        </Button >
