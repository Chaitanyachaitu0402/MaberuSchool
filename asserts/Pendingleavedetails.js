...
export default function Leavedetail({navigation}) {
    ...
    return (
        <SafeAreaView>
            ...
            <Button textColor={colors.primary} buttonColor={colors.primary} labelStyle={{ fontSize: 16, color: colors.bg,alignSelf:'center' }} style={{ width: '55%', height: 39, borderColor: colors.background, borderRadius: 6,alignSelf:'center',borderWidth:2,margin:10, }}onPress={()=>navigation.navigate('Parentleaveadd')}>    Add Leave  </Button >
