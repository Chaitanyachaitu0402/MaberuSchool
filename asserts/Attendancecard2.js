  ...
  return (
    <SafeAreaView>
      ...
      <View style={{ flexDirection: 'row', marginTop: 23, width: "96%", alignSelf: 'center', justifyContent: 'center', columnGap: 8, marginStart: 3 }}>
                        <Card style={{ width: "40%", height: 140 ,backgroundColor:colors.background}}onPress={()=>navigation.navigate('Staffattendancecreate')}>
                        ...
                        <Card style={{ width: "40%", height: 140, marginStart: 13,backgroundColor:colors.background }}onPress={()=>navigation.navigate('Staffattendanceview')}>
