    ...
    <ScrollView>
      {loading ? (
        ...
        <View style={{ flex: 1, backgroundColor: colors.primary, height: Dimensions.get('window').height }}>
          ...
          <View style={{ margin: 9 }}>
            <Text style={{ fontSize: 17, fontWeight: 'bold', color: colors.background, margin: 10 }}>Information List</Text>
            <View style={{ flexDirection: 'row', width: '96%', alignSelf: 'center', justifyContent: 'center', columnGap: 10 }}>
              <Card style={{ width: '30%', height: 110, marginStart: 8 }} onPress={() => handleCardPress('Classlist')}>
                ...
                <Text style={{ fontSize: 13, fontWeight: 'bold', alignSelf: 'center', color: colors.text }}>Add</Text>
                <Text style={{ fontSize: 13, fontWeight: 'bold', alignSelf: 'center', color: colors.text }}>Students</Text>
              </Card>
            ...
            <Text style={{ fontSize: 17, fontWeight: 'bold', color: colors.background, margin: 8 }}>Attendance Report</Text>
            ...
            <Text style={{ fontSize: 17, fontWeight: 'bold', color: colors.background, margin: 8 }}>Other Info</Text>
            <View style={{ flexDirection: 'row', width: '96%', alignSelf: 'center', justifyContent: 'center', columnGap: 8, marginStart: 3 }}>
              <Card style={{ width: '29%', height: 110, marginStart: 8 }} onPress={() => handleCardPress('Feesadd')}>
                ...
                <Text style={{ fontSize: 13, fontWeight: 'bold', alignSelf: 'center', color: colors.text }}>Fee</Text>
                <Text style={{ fontSize: 13, fontWeight: 'bold', alignSelf: 'center', color: colors.text }}>Details</Text>
              </Card>
              <Card style={{ width: '29%', height: 110, marginStart: 6 }} onPress={() => handleCardPress('Otherstafflist')}>
                <Icon name="cash-multiple" color={colors.bg} size={40} style={{ margin: 5, justifyContent: 'center', alignSelf: 'center', height: 44 }} />
                <Text style={{ fontSize: 13, fontWeight: 'bold', alignSelf: 'center', color: colors.text }}>Add</Text>
                <Text style={{ fontSize: 13, fontWeight: 'bold', alignSelf: 'center', color: colors.text }}>Other Staff</Text>
              </Card>
              <Card style={{ width: '29%', height: 110, marginStart: 13 }} onPress={() => handleCardPress('Teacherpendingleave')}>
                ...
                <Text style={{ fontSize: 13, fontWeight: 'bold', alignSelf: 'center', color: colors.text }}>Leave</Text>
                <Text style={{ fontSize: 13, fontWeight: 'bold', alignSelf: 'center', color: colors.text }}>Response</Text>
              </Card>
            </View>
          </View>
        </View>
