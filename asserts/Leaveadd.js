        ...
        <SafeAreaView>
            <ScrollView>
                <View style={{ flex: 1, backgroundColor: colors.primary, }}>
                    ...
                    <Button textColor={colors.text} buttonColor={colors.bg} labelStyle={{ fontSize: 20, color: colors.text, fontWeight: 'bold' }} style={{ width: '40%', height: 55, borderColor: colors.background, justifyContent: "center", alignSelf: 'center', borderRadius: 10, margin:9 }}onPress={home}>ADD
      </Button >
