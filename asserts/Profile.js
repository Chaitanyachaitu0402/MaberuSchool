  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.primary }}>
      ...
      <View style={{ backgroundColor: colors.background, height: 150, width: '100%', borderBottomRightRadius: 44, borderBottomLeftRadius: 44 }}>
        ...
        <Button textColor={colors.text} buttonColor={colors.bg} labelStyle={{ fontSize: 20, color: colors.text, fontWeight: 'bold' }} style={{ width: '40%', height: 60, borderColor: colors.primary, justifyContent: "center", alignSelf: 'center', borderRadius: 6, marginTop: 70 }}onPress={()=>navigation.navigate('Editprofile')} >
          Edit Profile
        </Button >
